        ...
        \item
            \begin{description}
                ...
                \item[(2)] $P(t) = \begin{bmatrix} P_2(t) \\ P_1(t) \\ P_F(t) \end{bmatrix}, P_2(t) + P_1(t) + P_F(t) = 1, P(0) = \begin{bmatrix} 1 \\ 0 \\ 0 \end{bmatrix}$
                    ...
                    We can solve A and B via partial fractions:
                    ...
                    $P_1(s) = \frac{\lambda_1c + \lambda_2}{\lambda_2(s + \lambda_1)} - \frac{\lambda_1c + \lambda_2}{\lambda_2(s + \lambda_1 + \lambda_2)}$

                    Finally, we find:

                    $P_1(t) = \frac{\lambda_1c + \lambda_2}{\lambda_2}e^{-\lambda_1t} - \frac{\lambda_1c + \lambda_2}{\lambda_2(s + \lambda_1 + \lambda_2)}e^{-(\lambda_1 + \lambda_2)t}$

                    $R_{system}(t) = P_2(t) + P_1(t) = e^{-(\lambda_1 + \lambda_2)t} + \frac{\lambda_1c + \lambda_2}{\lambda_2}e^{-\lambda_1t} - \frac{\lambda_1c + \lambda_2}{\lambda_2(s + \lambda_1 + \lambda_2)}e^{-(\lambda_1 + \lambda_2)t}$
